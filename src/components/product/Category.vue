<template>
    <span >
        <el-button type="primary" @click="toCreateCategoryLevel1()">添加类别</el-button>
        <el-input v-model="query" style="width:200px;margin-left:15px" @input="filter()" placeholder="搜索类型" >
            <template #prefix>
    ...
    <el-tree-v2 :data="data" :props="props" :height="208" ref="treeRef" :filter-method="myFilterMethod">
        ...
        <span >
            ...
            <span>
                ...
                <el-link style="margin-left:15px" type="warning" @click="createCategoryUpdate(node)">
                    <el-icon><EditPen /></el-icon>
                    修改
                </el-link>
                <el-link  style="margin-left:15px" type="danger" @click="toDelete(node)">
...
<!--新建一级类别的弹出对话框-->
    ...
    >
        <el-form-item label="类别名称" label-width="100px" prop="name">
            <el-input v-model="pmsCategory.name" style="width:300px"></el-input>
        </el-form-item>
        <el-form-item label="计量单位" label-width="100px" prop="productUnit">
            <el-input v-model="pmsCategory.productUnit" style="width:300px"></el-input>
        </el-form-item>
    </el-form>

    <template #footer>
        <el-button @click="toCancleCategoryLevel1">取消</el-button>
        <el-button type="primary" @click="toConfirmCreateCategoryLevel1()">新建</el-button>
    </template>
    ...
    <!--新建子类别的对话框-->
        ...
        width="500px">
    <el-form 
        :model="pmsCategorySon" 
        label-position="left" 
        :rules="createRule"
        ref="createSonForm"
    >
        <el-form-item label="类别名称" label-width="100px" prop="name">
            <el-input v-model="pmsCategorySon.name" style="width:300px"></el-input>
        </el-form-item>

        <el-form-item label="父级类别名称" label-width="100px">
            <el-input v-model="pmsCategorySon.parentName" readonly style="width:300px"></el-input>
        </el-form-item>

        <el-form-item label="类别等级" label-width="100px">
            <el-input v-model="pmsCategorySon.levelName" readonly style="width:300px"></el-input>
        </el-form-item>

        <el-form-item label="计量单位" label-width="100px" prop="productUnit">
            <el-input v-model="pmsCategorySon.productUnit" style="width:300px"></el-input>
        </el-form-item>
    </el-form>

    <template #footer>
        <el-button @click="toCancleCategorySon()">取消</el-button>
        <el-button type="primary" @click="toConfirmCreateCategorySon()">新建</el-button>
    </template>
    </el-dialog>
       ...
       <!--修改类别信息的对话框-->
        ...
        width="500px">
    <el-form 
        :model="pmsCategoryUpdate" 
        label-position="left" 
        :rules="createRuleUpdate"
        ref="createSonForm"
    >
        <el-form-item label="类别名称" label-width="100px" prop="name">
            <el-input v-model="pmsCategoryUpdate.name"  style="width:300px"></el-input>
        </el-form-item>

        <el-form-item label="父级类别名称"  label-width="100px" >
            <el-select 
                v-model="pmsCategoryUpdate.parentId" 
        ...
        <el-form-item label="类别等级" label-width="100px">
            <el-select 
                v-model="pmsCategoryUpdate.level" 
                class="m-2" 
                placeholder="Select" 
                size="large" 
        ...
        <el-form-item label="计量单位" label-width="100px" prop="productUnit">
            <el-input v-model="pmsCategoryUpdate.productUnit" style="width:300px"></el-input>
        </el-form-item>
    </el-form>

    <template #footer>
        <el-button @click="toCancleCategoryUpdate()">取消</el-button>
        <el-button type="primary" @click="toUpdateCategory()">修改</el-button>
    </template>
    </el-dialog>
...
export default {
    ...
    methods:{
        ...
        filter(){
            this.$refs.treeRef.filter(this.query)
        }
